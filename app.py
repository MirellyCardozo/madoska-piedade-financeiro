...
def preparar_dataframe(df):
    # Data vem como texto DD/MM/AAAA → converter para datetime para cálculos
...
menu = st.sidebar.selectbox(
    "Menu",
    ["Registrar Movimento", "Dashboard", "Lucro por Período", "Relatório PDF"]
)
...
if menu == "Registrar Movimento":
    ...
    if st.button("💾 Salvar"):
        # Salvar data como texto DD/MM/AAAA
